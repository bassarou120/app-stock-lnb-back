...
<head>
    <meta charset="utf-8">
    <title>Rapport des Entrées de Stock</title>
    <style>
        @page {
...
<body>
    ...
    <h1>Rapport des Entrées de Stock</h1>
    ...
    <div class="filters-info">
        ...
        <ul>
            ...
            <li>
                ...
                @if(isset($filters['id_fournisseur']) && !empty($filters['id_fournisseur']))
                    {{ \App\Models\Fournisseur::find($filters['id_fournisseur'])->nom ?? 'N/A' }}
                @else
                    Tous
                @endif
            </li>
    ...
    @if($mouvements->isEmpty())
        <p class="no-data">Aucune entrée de stock trouvée pour les critères de recherche spécifiés.</p>
    @else
        <table>
            <thead>
                <tr>
    ...
    <div class="footer-info">
        Rapport des Entrées de Stock - Système de Gestion de Stock et Immobilisations
    </div>
</body>
</html>
