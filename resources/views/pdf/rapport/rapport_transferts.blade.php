  ...
  <tr>
    ...
    <div style="width: 100%; margin-bottom: 10px;text-align: center;">
        ...
        <h1 style="font-size: 20px; margin: 10px 0; font-weight: bold;">
            Rapport des Transferts d'Immobilisations
        </h1>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
          ...
          <td>{{ $transfert->old_employe ? ($transfert->old_employe->nom . ' ' . $transfert->old_employe->prenom) : '-' }}</td>
          <td>{{ $transfert->employe ? ($transfert->employe->nom . ' ' . $transfert->employe->prenom) : '-' }}</td>
