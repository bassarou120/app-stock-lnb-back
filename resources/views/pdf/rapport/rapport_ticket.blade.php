...
<body>
    ...
    <div class="filters-info">
        ...
        <ul>
            ...
            @if($typeRapport === 'entree ticket' || $typeRapport === 'retour ticket' || $typeRapport === 'annulation ticket')
                <li>
                    <strong>Coupon Ticket :</strong>
                    {{ $filterLabels['coupon_ticket'] ?? 'Tous' }}
                </li>
                <li>
                    <strong>Compagnie :</strong>
                    {{ $filterLabels['compagnie'] ?? 'Toutes' }}
                </li>
    ...
    <div class="footer-info">
        Rapport de Tickets - Système de Gestion de Stock et Immobilisations
    </div>
</body>
</html>
